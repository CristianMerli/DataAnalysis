...
\begin{equation}                                                                                                            % Equation-start
  ...
  \label{eqn:stat_eq}                                                                                                       % Reference-label to equation
...
\begin{equation}                                                                                                            % Equation-start
  ...
  \label{eqn:heat_tr_eq}                                                                                                    % Reference-label to equation
\end{equation}                                                                                                              % Equation-end
\begin{equation}                                                                                                            % Equation-start
  \bar{Q} = \frac{|Q_c|+|Q_f|}{2}                                                                                           % Formula
  \qquad\text{e}\qquad                                                                                                      % Conjunction txt
  \Delta{Q_{c-f}} = Q_c+Q_f                                                                                                 % Formula
  \label{eqn:heat_tr_eq2}                                                                                                   % Reference-label to equation
\end{equation}                                                                                                              % Equation-end
...
\begin{equation}                                                                                                            % Equation-start
  \Delta{T_{m.l.}} = \frac{\Delta_{1}-\Delta_{2}}{\log_e{(\frac{\Delta_{1}}{\Delta_{2}})}}                                  % Formula
...
\begin{equation}                                                                                                            % Equation-start
  ...
  \label{eqn:ghtc_eq2}                                                                                                      % Reference-label to equation
\end{equation}                                                                                                              % Equation-end
\begin{equation}                                                                                                            % Equation-start
  \mathcal{\dot{C}}_{min} = min\{\dot{m}_c\mathcal{C}_{p,c}(T),\space\dot{m}_f\mathcal{C}_{p,f}(T)\}                        % Formula
  \qquad\text{e}\qquad                                                                                                      % Conjunction txt
  \mathcal{\dot{C}}_{max} = max\{\dot{m}_c\mathcal{C}_{p,c}(T),\space\dot{m}_f\mathcal{C}_{p,f}(T)\}                        % Formula
...
\begin{equation}                                                                                                            % Equation-start
  R_{cond} = \frac{\log_e{(\frac{d_e}{d_i})}}{2\pi\lambda_c(T)LN_t}                                                         % Formula
  \label{eqn:condr}                                                                                                         % Reference-label to equation
\end{equation}                                                                                                              % Equation-end
\begin{equation}                                                                                                            % Equation-start
  \mu(T) = \nu(T)\rho(T)                                                                                                    % Formula
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{equation}                                                                                                            % Equation-start
  Nu_{t,lam} = \frac{}{}                                                                          % Formula
  \label{eqn:nu_pipe_l}                                                                                                     % Reference-label to equation
\end{equation}                                                                                                              % Equation-end
\begin{equation}                                                                                                            % Equation-start
  Nu_{t,turb} = \frac{}{}                                                                         % Formula
  \qquad\text{con}\qquad                                                                                                    % Conjunction txt
  k_{attr} = \frac{}{}                                                                            % Formula
