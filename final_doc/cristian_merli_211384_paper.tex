...
\label{sec:conclusions}                                                                                                     % "conclusions" reference-label definition and following section text
  ...
  esterna (in vetro pyrex), oscillano tra lo 0.4 e l'1.4\% di quello totale disperso; stanno a significare che il grosso
  della dispersione avviene altrove. Con molta probabilità, una parte consistente avviene sulle tubazioni che conducono i
  fluidi dai punti di misurazione della temperatura, allo scambiatore. Un'altra osservazione che è possibile fare alla
  luce dei dati sopra citati, è che la differenza precentuale tra il calcolo della potenza termica trasmessa effettuato
  con approccio sperimentale ovvero teorico, è compresa tra il 33.5 ed il 38.4\%. Questi valori possono essere
