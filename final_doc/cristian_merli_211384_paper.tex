...
\begin{equation}                                                                                                            % Equation-start
  \sum_{i=0}^{\infty} a_i x^i                                                                                               % Formula
...
\begin{table}[ht!]                                                                                                          % Table-start
  ...
  \begin{tabular}{||c|c|c|c|c||}                                                                                            % 5 columns tabular with centered text
    ...
    \hline
  \end{tabular}                                                                                                             % End tabular definition
  \caption{Valori rilevati ottenuti mediante i calcoli ingegneristici effettuati}                                           % Table caption
  \label{tab:measures_calcs}                                                                                                % Reference-label to table
\end{table}                                                                                                                 % Table-end
