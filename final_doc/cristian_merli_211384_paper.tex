...
\label{subsec:prelim_phase}                                                                                                 % "prelim_phase" reference-label definition and following subsection text  
  ...
  autonoma le diverse misure all'interno del database, ripulendo anche dati corrispondenti ad "altre operazioni", per poi
  mostrare il tutto graficamente evidenziando le finestre dati corrispondenti alle misure stesse
...
\label{subsec:thermovars_polyapprox}                                                                                        % "thermovars_polyapprox" reference-label definition and following subsection text  
  ...
  derivano da diverse fonti ufficiali ed affidabili. Nel dettaglio, i dati riguardanti i fluidi: aria ed acqua, sono
  stati forniti dal docente sottoforma di tabelle (pdf), poi trascritte in file CSV ed importate sottoforma di database.
  Procedura analoga, anche per i materiali costituenti lo scambiatore: acciaio inox AISI-316 (tubi interni) e vetro
  borosilicato (pyrex, tubo esterno), i cui dati sono però derivanti da fonti online. Di seguito, sono riportate nel
  dettaglio, le fonti dati utilizzate:
  \begin{itemize}                                                                                                           % List-start
    ...
    \item \textbf{proprietà AISI-316:}
      fonte \textit{\href{http://www.inductor-jmag.ru/files/content/a129160.pdf}{http://www.inductor-jmag.ru/files/content/a129160.pdf}}
      pagina 28 pdf, Table 4 (pagina 21 file)
    ...
    \item \textbf{proprietà vetro pyrex:}
      fonte \textit{\href{https://nvlpubs.nist.gov/nistpubs/Legacy/RPT/nbsreport7836.pdf}{https://nvlpubs.nist.gov/nistpubs/Legacy/RPT/nbsreport7836.pdf}}
      pagina 39 pdf, Table 6 (pagina 16 file)
