...
\label{subsec:adimnum_meth}                                                                                                 % "adimnum_meth" reference-label definition and following subsection text
  ...
  \textit{\textbf{[}\ref{eqn:nu_shell}\textbf{]}} (con diametri idraulici equivalenti) ed i coefficienti di scambio
...
\label{subsec:extnat_conv}                                                                                                  % "extnat_conv" reference-label definition and following subsection text 
  ...
  fatta una stima della temperatura sulla superficie del vetro, calcolando la temperatura media tra la ambiente e fluido
  esterno. Questo valore, è stato utilizzato poi per definire la conducibilità termica del vetro e quindi la resistenza
  conduttiva dello stesso attraverso l'equazione \textit{\textbf{[}\ref{eqn:cond_r}\textbf{]}}. Successivamente, sono stati
  determinati i valori di conducibilità termiche, viscosità dinamiche e numeri di Prandlt medi del fluido freddo (valori
  intermedi tra quelli calcolati sulla sezione in ingresso e in uscita, al capitolo
  \textit{\textbf{[}\hyperref[subsec:adimnum_meth]{Capitolo }\ref{subsec:adimnum_meth},
  \hyperref[subsec:adimnum_meth]{pagina }\pageref{subsec:adimnum_meth}\textbf{]}}).
  ..........
  \textit{\textbf{[}\ref{eqn:gr}\textbf{]}}
  \textit{\textbf{[}\ref{eqn:ra}\textbf{]}}
  \textit{\textbf{[}\ref{eqn:nu_ra}\textbf{]}}
...
\label{sec:conclusions}                                                                                                     % "conclusions" reference-label definition and following section text
  ...
  atta al calcolo del numero adimensionale di Reynolds in maniera alternativa:
  \textit{\textbf{[}\ref{eqn:re_alt}\textbf{]}}. I risultati ottenuti, sono comparabili con quelli ricavati mediante
  l'applicazione del metodo precedentemente descritto.
  ..........
